...
const SocialStudioSection: React.FC = () => {
    return (
        <section className="py-24 px-6 bg-white overflow-hidden relative">
            <div className="absolute top-0 left-0 w-full h-full bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-teal-50 via-white to-white z-0"></div>

            <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center relative z-10">
                <div className="space-y-8">
                    <span className="text-teal-600 font-bold tracking-widest uppercase text-sm flex items-center gap-2">
                        <Sparkles size={16} />
                        Social Studio
                    </span>
                    <h2 className="text-4xl md:text-6xl font-black text-slate-900 tracking-tighter leading-tight">
                        Fire your <br />
                        <span className="text-teal-600">Digital Marketer.</span>
                    </h2>
                ...
                <div className="relative">
                    ...
                    <div className="relative z-10 bg-white border border-slate-200 rounded-3xl p-6 shadow-2xl shadow-teal-900/10 rotate-3 transition-transform hover:rotate-0 duration-500">
                        <div className="flex items-center gap-3 mb-4">
                            ...
                            <span className="ml-auto text-xs font-bold text-white bg-teal-600 px-2 py-1 rounded-md">Ready</span>
                        </div>
