        ...
        <section className="py-24 px-6 bg-white relative overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto relative z-10">
                <div className="text-center mb-16 space-y-6">
                    <span className="text-rose-600 font-bold tracking-widest uppercase text-sm">Stop the Bleeding</span>
                    <h2 className="text-4xl md:text-6xl font-black text-slate-900 tracking-tighter">
                        Simplify your stack.<br />
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-rose-500 to-rose-700">Multiply your profit.</span>
                    </h2>
                ...
                <div ref={ref} className="grid lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="relative">
                        <div className="space-y-4">
                            {oldStack.map((item, i) => (
                                <motion.div
                                    ...
                                    className="flex items-center justify-between p-6 rounded-2xl bg-slate-100 border border-slate-200 grayscale opacity-60 hover:opacity-100 hover:bg-red-950/20 hover:border-red-500/30 transition-all group"
                                >
                                    ...
                                    <span className="text-xl font-mono text-slate-500 group-hover:text-red-400 transition-colors">${item.price}</span>
                                </motion.div>
                            ))}
                        </div>
                        ...
                        <motion.div
                            ...
                            transition={{ delay: 1 }}
                            className="mt-8 pt-8 border-t border-slate-200 flex justify-between items-center px-6"
                        >
                            <span className="text-slate-500 font-bold uppercase tracking-widest">Monthly Burn</span>
                    ...
                    <motion.div
                        ...
                        className="relative"
                    >
                        <div className="absolute inset-0 bg-teal-500/20 blur-[100px] rounded-full animate-pulse"></div>

                        <div className="relative z-10 p-10 rounded-[2.5rem] bg-gradient-to-br from-teal-600 to-teal-800 border border-teal-500/30 shadow-2xl text-white">
                            <div className="flex items-start justify-between mb-12">
                                <div>
                                    <h3 className="text-3xl font-black text-white">RetainOS</h3>
                                    <p className="text-teal-200 font-medium">Enterprise Edition</p>
                                </div>
                            ...
                            <div className="mt-12 pt-12 border-t border-white/20 flex justify-between items-center">
                                <div>
                                    <p className="text-sm font-bold text-teal-200 uppercase tracking-widest mb-2">Net Value Created</p>
                                ...
                                <div className="text-right">
                                    <p className="text-sm font-bold text-emerald-300 uppercase tracking-widest mb-1">Instant Savings</p>
