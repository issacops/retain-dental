...
export const LoginPage: React.FC<LoginPageProps> = ({ clinics = [], activeClinic }) => {
    ...
    return (
        <div className="h-screen w-full overflow-y-auto overflow-x-hidden font-sans text-slate-200 transition-colors duration-1000 relative"
            ...
            {/* Scrollable Content Wrapper - Centering */}
            <div className="min-h-screen w-full flex items-center justify-center p-6 relative z-10">
                <div className="w-full max-w-md relative glass-panel border border-white/10 p-12 rounded-[40px] shadow-2xl backdrop-blur-xl bg-slate-900/60 transition-all duration-500">
